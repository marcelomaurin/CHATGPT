...
| `TAIHumanPoseDetector` | `aihumanposedetector.pas` | `openai_vision` | Beta | Detecção de pose humana via MediaPipe Bridge DLL/SO com runtime versionado e fallback de simulação. |
