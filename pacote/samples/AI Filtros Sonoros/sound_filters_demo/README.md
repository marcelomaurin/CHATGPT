...
Este exemplo demonstra o uso dos filtros de processamento de sinais analógicos e multiplexadores de RF incluídos na aba **`AI Filtros Sonoros`** da paleta de componentes do Lazarus, implementados em **Pascal puro** de alta performance.
