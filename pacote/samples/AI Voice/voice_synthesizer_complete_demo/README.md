# Voice Synthesizer Complete Demo (aivoicesynthesizer)

This sample project demonstrates the usage of component `aivoicesynthesizer` from the `openai_voice` package.
