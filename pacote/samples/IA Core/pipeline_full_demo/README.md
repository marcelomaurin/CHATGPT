# Pipeline Full Demo (aipipeline)

This sample project demonstrates the usage of component `aipipeline, chatgpt, aioutput, aioutput_docs` from the `openai_core` package.
