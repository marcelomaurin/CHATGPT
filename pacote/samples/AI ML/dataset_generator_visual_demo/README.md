# Dataset Generator Visual Demo (aidatasetgenerator)

This sample project demonstrates the usage of component `aidatasetgenerator` from the `openai_ml` package.
...
2. Verify package `openai_ml` is available or referenced.
