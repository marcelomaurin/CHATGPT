...
gui_samples = {
    'pt': [
        ...
        {'name': 'image_filters_demo', 'desc': 'Processamento matricial de imagens interativo.', 'comps': 'Filtros da aba AI Image (TAIImageFilters)', 'how': 'Aplica kernels convolucionais, binarizações e detecções de borda nativamente em canvas Pascal.'},
        {'name': 'sound_filters_demo', 'desc': 'Processamento digital de sinais (DSP) e modulações de frequências.', 'comps': 'Filtros da aba AI Filtros Sonoros (TAISoundFilters)', 'how': 'Simula filtros passa-baixas/altas, multiplexações FDM, TDM, CDM e OFDM ortogonal.'},
    ...
    'en': [
        ...
        {'name': 'image_filters_demo', 'desc': 'Interactive image matrix filters playground.', 'comps': 'AI Image tab filters (TAIImageFilters)', 'how': 'Applies Sobel, Gaussian, Canny, and Grayscale filters to LCL TBitmap canvases.'},
        {'name': 'sound_filters_demo', 'desc': 'Digital Signal Processing (DSP) and modulation simulator.', 'comps': 'AI Filtros Sonoros tab filters (TAISoundFilters)', 'how': 'Models LowPass/HighPass filters, FDM, TDM, CDM, and orthogonal OFDM multiplexing.'},
