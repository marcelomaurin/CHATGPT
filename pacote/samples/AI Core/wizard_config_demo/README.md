# Wizard Config Demo (aiwizardconfig)

This sample project demonstrates the usage of component `aiwizardconfig, aiproject, chatgpt, aipipeline` from the `openai_core` package.
