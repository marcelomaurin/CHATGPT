...
Este exemplo demonstra o uso dos filtros de processamento de imagens matriciais inclusos na aba **`IA Image`** da paleta de componentes do Lazarus, implementados em **Pascal puro** de alta performance.
