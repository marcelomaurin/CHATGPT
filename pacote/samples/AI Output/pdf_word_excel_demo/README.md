# Pdf Word Excel Demo (aioutput_docs)

This sample project demonstrates the usage of component `aioutput_docs` from the `openai_output` package.
...
2. Verify package `openai_output` is available or referenced.
