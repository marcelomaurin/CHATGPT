# Pose Animation Demo (aiposelibrary)

This sample project demonstrates the usage of component `aiposelibrary, aianimationsequence, aiskeletonrig` from the `openai_graphic` package.
