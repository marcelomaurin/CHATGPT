# Physics Training Demo (aiphysicssimulator)

This sample project demonstrates the usage of component `aiphysicssimulator, aitrainingenvironment` from the `openai_graphic` package.
...
2. Verify package `openai_graphic` is available or referenced.
