...
| **[AI_Arm_robot](AI Industrial/AI_Arm_robot/)** | `pacote/samples/AI Industrial/AI_Arm_robot` | 3D model for calculating and visualizing the angles of a 6-axis robotic arm. |
