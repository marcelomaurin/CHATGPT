# Training Report Demo (aitrainingreport)

This sample project demonstrates the usage of component `aitrainingreport, aigraphmap` from the `openai_graph` package.
