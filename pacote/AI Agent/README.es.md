...
- **Propiedades (Published):**
  ...
  - `MapaDeMemoria: TAIMapaDeMemoria` - Historial operativo compartido entre etapas.
...
- **Propiedades (Published):**
  ...
  - `MapaDeMemoria: TAIMapaDeMemoria` - Auditoría de memoria.
...
- **Propiedades (Published):**
  ...
  - `Items: TAIMapaDeMemoriaItem` - Lista ordenada de pasos y análisis de los agentes.
