...
comps_info = {
    ...
    'es': [
        ...
        {'name': 'TAIVoiceSynthesizer', 'desc': 'Motor de síntesis de voz (TTS) nativo Windows y Linux.', 'props': 'Volume, Rate, VoiceName, Asynchronous', 'methods': 'Say, GetAvailableVoices', 'role': 'Hablar reportes o alertas generadas por la IA a través del hardware.'}
    ],
    'fr': [
    ...
    'it': [
        ...
        {'name': 'TTokenizer', 'desc': 'Tokenizzatore di testo rapido e segmentatore di parole.', 'props': 'LowerCase', 'methods': 'Tokenize, GetVocabulary', 'role': 'Pre-elaborare stringhe in indici numerici (token).'},
